...
INSERT INTO course(code, points, description) VALUES ('APMA E2101', 3.0, 'Prerequisites: Calculus III. A unified, single-semester introduction to differential equations and linear algebra with emphases on (1) elementary analytical and numerical technique and (2) discovering the analogs on the continuous and discrete sides of the mathematics of linear operators: superposition, diagonalization, fundamental solutions. Concepts are illustrated with applications using the language of engineering, the natural sciences, and the social sciences. Students execute scripts in Mathematica and MATLAB (or the like) to illustrate and visualize course concepts (programming not required).');
INSERT INTO course(code, points, description) VALUES ('BIOL UN3031', 3.0, 'Prerequisites: BIOL UN2005 and BIOL UN2006 or the equivalent. General genetics course focused on basic principles of transmission genetics and the application of genetic approaches to the study of biological function. Principles will be illustrated using classical and contemporary examples from prokaryote and eukaryote organisms, and the experimental discoveries at their foundation will be featured.');
INSERT INTO course(code, points, description) VALUES ('COMS W4156', 3.0, 'Prerequisites: (COMS W3157) or equivalent. Software lifecycle using frameworks, libraries and services. Major emphasis on software testing. Centers on a team project.');
INSERT INTO course(code, points, description) VALUES ('COMS W3261', 3.0, 'Prerequisites: (COMS W3203) Corequisites: COMS W3134,COMS W3136,COMS W3137 Regular languages: deterministic and non-deterministic finite automata, regular expressions. Context-free languages: context-free grammars, push-down automata. Turing machines, the Chomsky hierarchy, and the Church-Turing thesis. Introduction to Complexity Theory and NP-Completeness.');
INSERT INTO course(code, points, description) VALUES ('MECE E4211', 3.0, 'Prerequisites: (MECE E3301) MECE E3301. Energy sources such as oil, gas, coal, gas hydrates, hydrogen, solar, and wind. Energy conversion systems for electrical power generation, automobiles, propulsion and refrigeration. Engines, steam and gas turbines, wind turbines; devices such as fuel cells, thermoelectric converters, and photovoltaic cells. Specialized topics may include carbon-dioxide sequestration, cogeneration, hybrid vehicles and energy storage devices.');
INSERT INTO course(code, points, description) VALUES ('COMS W3157', 3.0, 'Prerequisites: (COMS W3134) or (COMS W3137) C programming language and Unix systems programming. Also covers Git, Make, TCP/IP networking basics, C++ fundamentals.');
INSERT INTO course(code, points, description) VALUES ('COMS W3134', 3.0, 'Prerequisites: (COMS W1004) or knowledge of Java. Data types and structures: arrays, stacks, singly and doubly linked lists, queues, trees, sets, and graphs. Programming techniques for processing such structures: sorting and searching, hashing, garbage collection. Storage management. Rudiments of the analysis of algorithms. Taught in Java. Note: Due to significant overlap, students may receive credit for only one of the following three courses: COMS W3134, COMS W3136, COMS W3137.');
INSERT INTO course(code, points, description) VALUES ('COMS W1004', 3.0, 'A general introduction to computer science for science and engineering students interested in majoring in computer science or engineering. Covers fundamental concepts of computer science, algorithmic problem-solving capabilities, and introductory Java programming skills. Assumes no prior programming background. Columbia University students may receive credit for only one of the following two courses: 1004 or 1005.');
INSERT INTO course(code, points, description) VALUES ('MATH UN1201', 3.0, 'Prerequisites: MATH UN1101 or the equivalent Vectors in dimensions 2 and 3, complex numbers and the complex exponential function with applications to differential equations, Cramers rule, vector-valued functions of one variable, scalar-valued functions of several variables, partial derivatives, gradients, surfaces, optimization, the method of Lagrange multipliers.');
INSERT INTO course(code, points, description) VALUES ('MECE E3301', 3.0, 'Classical thermodynamics. Basic properties and concepts, thermodynamic properties of pure substances, equation of state, work, heat, the first and second laws for flow and nonflow processes, energy equations, entropy, and irreversibility. Introduction to power and refrigeration cycles.');

INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (1,  '2020_3', '10:10', '11:25', 125);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (2,  '2020_3', '12:40', '13:55', 150);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (3,  '2020_3', '08:40', '9:55',  150);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (4,  '2020_3', '18:40', '19:55', 100);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (5,  '2021_1', '12:10', '14:10', 70);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (6, '2021_1', '13:40', '15:40', 60);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (7,  '2020_1', '10:10', '11:25', 125);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (8, '2020_1', '12:40', '13:55', 200);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (9, '2019_1', '08:40', '9:55',  350);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (10, '2019_3', '18:40', '19:55', 300);
INSERT INTO section(course_id, semester, start_time, end_time, capacity) VALUES (10, '2020_1', '12:10', '14:10', 250);
...
INSERT INTO review(course_id, instructor_id, content) VALUES (9, 8, 'I took this class online and it was very manageable. The exams were open note which I greatly appreciated and it made the class a lot easier to do well in. He also drops one homework assignment. I recommend this class both if you want to learn calc iii thoroughly but also for a GPA boost! Also, Im taking this online so if you take this in person it might be different (especially about the GPA boost part) however he is a really great teacher so I still recommend him for an in-person class.');
INSERT INTO review(course_id, instructor_id, content) VALUES (7, 10, 'My only qualm is that he doesnt give out a week by week syllabus coverage. Other than that, Hagrid is great at breaking down and explaining abstract concepts and very patient with our questions. His anecdotes and side tangents are usually relevant, even if they arent they really lighten the atmosphere.');
INSERT INTO review(course_id, instructor_id, content) VALUES (7, 10, 'Feix Pletscher is not a good lecturer. The currciuculum glosses over a lot of topics. The motivation behind the data structures are not explained. Honestly, data structures at Columbia is a joke. For a class that is very important to computer science, you will feel like you can do the problem sets and maybe get As, but will end the class thinking that you did not learn anything. Connections between the data structures are not explained. A lot of times I had knowledge of the topic behind explained, but sat there and saw him explain it for the first time and thought that if this was my first time being exposed to what he is saying, I wouldnt have grasped the material.');
INSERT INTO review(course_id, instructor_id, content) VALUES (6, 4, 'The emphasis of the course is on trivial details of tracing code, pointers, syntactical sugar, and sockets programming. You end up learning a good deal of C/C++, and forgetting the same content in a matter of months. The lectures are clear, TAs are incredibly dedicated, and Ted cares a great deal, but the focus throughout the course is frankly petty. Its disappointing that so much talent and energy is dedicated to details that should be taken for granted.');
INSERT INTO review(course_id, instructor_id, content) VALUES (6, 4, 'Take this class seriously, and youll learn a lot. Most importantly, youll learn how to hold yourself accountable and have high standards. Youll get eaten alive in the competitive world of software without that kind of attitude. Ted Mosby is one of the most practical professors Ive had at Columbia, and Im glad I got knocked off my high horse by him and learned some perspective.');
INSERT INTO review(course_id, instructor_id, content) VALUES (6, 4, 'Teds lectures go by quickly, so make sure you take notes quickly or have recordings for backup (usually if you ask the listserv for recordings, someone will have one). You want to use a combination of hand-written and typed notes because he talks fast and writes a lot of code and diagrams on the board.');
...
INSERT INTO review(course_id, instructor_id, content) VALUES (2, 6, 'The worst class I have taken in any science department while at Columbia for four years. This teacher lectures solely from slides in a rote way pegged firmly behind her lectern. This would not be horrible were it not for the fact that her slides have mistakes, she cannot answer questions, shes unapprochable and unwilling to receive student criticism, her assignments are busy-work, and all her content-knowledge is derived from the text book.');
...
INSERT INTO takes(student_id, section_id) VALUES (2,11);
...
INSERT INTO takes(student_id, section_id) VALUES (11,8);
